...
print('----------Finais----------')
print(f'1º- CAMPEÃO: {winner.name} ({winner.lastMotivation:.2f})')
print(f'2º- VICE: {second.name} ({second.lastMotivation:.2f})')
print('----------Terceiro Lugar----------')
print(f'3º- Terceiro: {third.name} ({third.lastMotivation:.2f})')
print(f'4º- Quarto: {fourth.name} ({fourth.lastMotivation:.2f})')
